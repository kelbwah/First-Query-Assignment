...
SELECT prod_id, prod_desc, prod_price FROM product
where prod_quantity < 20;
...
SELECT rep_id, SUM(cust_balance) as balance_sum FROM customer
GROUP BY rep_id
ORDER BY rep_id;
